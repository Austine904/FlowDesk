<aside id="sidebar" class="fixed top-0 left-0 h-full w-64 bg-slate-900 flex flex-col z-20">
    ...
    <nav class="flex-1 px-3 py-4 overflow-y-auto space-y-1">
        ...
        <?= navItem(base_url('admin/outgoing_payments'), 'Outgoing Payments', '<svg fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h12m0 0l-4-4m4 4l-4 4m0 6H4m0 0l4 4m-4-4l4-4"/></svg>', 'admin/outgoing_payments') ?>
