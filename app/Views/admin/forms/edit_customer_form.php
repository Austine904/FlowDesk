<form action="<?= base_url('admin/customers/update/' . $customer['id']) ?>" method="POST" class="space-y-5">
<?= csrf_field() ?>
...
<div class="flex items-center gap-3 pb-2 border-b border-gray-100">
    ...
    <div>
        <h4 class="text-sm font-semibold text-gray-900">Edit Customer</h4>
        <p class="text-xs text-gray-400">Update the customer's contact details</p>
    </div>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div class="space-y-1.5">
        ...
        <div class="relative">
            ...
            <input type="text" name="name" id="name" required value="<?= esc($customer['name']) ?>"
    ...
    <div class="space-y-1.5">
        ...
        <div class="relative">
            ...
            <input type="text" name="phone" id="phone" required value="<?= esc($customer['phone']) ?>"
                   class="w-full rounded-lg border border-gray-200 pl-10 pr-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 bg-gray-50 hover:bg-white hover:border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors">
        </div>
    </div>
</div>
...
<div class="space-y-1.5">
    ...
    <div class="relative">
        ...
        <input type="email" name="email" id="email" value="<?= esc($customer['email'] ?? '') ?>"
               class="w-full rounded-lg border border-gray-200 pl-10 pr-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 bg-gray-50 hover:bg-white hover:border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors">
    </div>
</div>
...
<div class="space-y-1.5">
    ...
    <div class="relative">
        ...
        <textarea name="address" id="address" rows="2" placeholder="123 Main Street, Nairobi"
                  class="w-full rounded-lg border border-gray-200 pl-10 pr-3 py-2.5 text-sm text-gray-900 placeholder-gray-400 bg-gray-50 hover:bg-white hover:border-gray-300 focus:bg-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors resize-none"><?= esc($customer['address'] ?? '') ?></textarea>
    </div>
</div>
