...
<div class="bg-white rounded-xl shadow-sm border border-gray-200">
    <div class="px-6 py-4 border-b border-gray-100">
        <h3 class="text-base font-semibold text-gray-900"><i class="fas fa-tools mr-2"></i> My Assigned Jobs</h3>
    </div>
    <div class="p-6">
                    ...
                    <?php if (!empty($jobs)): ?>
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-4 py-3 text-sm">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800"><?= esc($job['job_status'] ?? '') ?></span>
                            </td>
